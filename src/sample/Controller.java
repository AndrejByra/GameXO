...
public class Controller {
        ...
        try {
            if (state == State.PLAYING) {
                ...
                switch (i){
                    ...
                    case 2:toggle(1);toggle(6);toggle(3);toggle(5);toggle(7);break;
                    case 3:toggle(2);toggle(6);toggle(7);toggle(8);toggle(4); break;
                    case 4:toggle(8);toggle(7);toggle(3); break;
                    case 5:toggle(1);toggle(2);toggle(6);toggle(10);toggle(9); break;
                    ...
                    case 8:toggle(4);toggle(3);toggle(7);toggle(11);toggle(12); break;
                    ...
                    case 12:toggle(8);toggle(7);toggle(11);toggle(15);toggle(16); break;
                    case 13:toggle(9);toggle(10);toggle(14); break;
                    case 14:toggle(13);toggle(9);toggle(10);toggle(11);toggle(15); break;
                    case 15:toggle(14);toggle(10);toggle(11);toggle(12);toggle(16); break;
                    case 16:toggle(15);toggle(11);toggle(12); break;
            }
                if (isGamewin() && state ==State.PLAYING)
                {
                    state=State.END;
                    fieldmsg.appendText("You Win !");
                    state = State.END;
                }
            }
        }catch(Exception e){
    ...
    public void toggle(int i) throws Exception{
        ...
        Image image;
        System.out.println(img4.getImage().getUrl());
        String current = new java.io.File( "." ).getCanonicalPath();
        fieldmsg.clear();
        if(field[row][col]==false){
            image=new Image(new FileInputStream( current+"\\src\\img\\o.png"));
        }
        else{
            image=new Image(new FileInputStream(current+"\\src\\img\\x.png"));
        }
        switch (i) {
